...
echo ">>> ip netns exec p04s07 ip addr add 10.40.97.1/30 dev p04s07LinkToGS"
ip netns exec p04s07 ip addr add 10.40.97.1/30 dev p04s07LinkToGS
echo ">>> ip netns exec gs1 ip addr add 10.40.97.2/30 dev ifgs97"
ip netns exec gs1 ip addr add 10.40.97.2/30 dev ifgs97
...
echo ">>> /usr/local/bin/updatemap --dev $iface --delay 30.0"
/usr/local/bin/updatemap --dev $iface --delay 30.0
